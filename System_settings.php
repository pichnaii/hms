...
class system_settings extends MY_Controller
{
    ...
    function index()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'default_email' => DEMO ? 'ungrothana010@gmail.com' : $this->input->post('email'),
                'language' => $lang,
    ...
    function updates()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $updates = get_remote_contents($protocol.'api.cloudaseansolution.com/v1/update/', $fields);
    ...
    function getWarehouses()
    {
		...
		if(!$this->config->item('one_warehouse')){
			$delete_warehouse = "<a href='#' class='tip po' title='<b>" . lang("delete_warehouse") . "</b>' data-content=\"<p>" . lang('r_u_sure') . "</p><a class='btn btn-danger po-delete111111' href='" . site_url('system_settings/delete_warehouse/$1') . "'>" . lang('i_m_sure') . "</a> <button class='btn po-close'>" . lang('no') . "</button>\"  rel='popover'><i class=\"fa fa-trash-o\"></i></a>";
        }

        if($this->Settings->alert_qty_by_warehouse == 1){
            $link_alert = "<a href='" . site_url('system_settings/product_alert_warehouse/$1') . "' class='tip' title='" . lang("product_alert_warehouse") . "'><i class=\"fa fa-eye\"></i></a> ";
        }else{
            $link_alert = "";
        }
    ...
    {
		$this->cus->checkPermissions('index',null,'supplier_opening_balances');
		$add_link = anchor('purchases/add_payment/$1', '<i class="fa fa-edit"></i> ' . lang('add_payment_supplier_opening_balance'), 'data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal"');
		$view_link = anchor('purchases/payments/$1', '<i class="fa fa-edit"></i> ' . lang('view_payment_supplier_opening_balances'), 'data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal"');
	...
	function getProductPromotions()
    {
        ...
        $this->datatables->add_column("Actions", "<div class=\"text-center\"><a href='" . site_url('system_settings/product_promotion_items/$1') . "' class='tip' title='" . lang("product_promotion_items") . "'><i class=\"fa fa-eye\"></i></a>  <a href='" . site_url('system_settings/edit_product_promotion/$1') . "' class='tip' title='" . lang("edit_product_promotion") . "' data-toggle='modal' data-backdrop='static' data-keyboard='false' data-target='#myModal'><i class=\"fa fa-edit\"></i></a> <a href='#' class='tip po' title='<b>" . lang("delete_product_promotion") . "</b>' data-content=\"<p>" . lang('r_u_sure') . "</p><a class='btn btn-danger po-delete' href='" . site_url('system_settings/delete_product_promotion/$1') . "'>" . lang('i_m_sure') . "</a> <button class='btn po-close'>" . lang('no') . "</button>\"  rel='popover'><i class=\"fa fa-trash-o\"></i></a></div>", "id,category_id");
        echo $this->datatables->generate();
    }
    ...
    {
        $this->load->library('datatables');
		$delete_salesman_group = "<a href='#' class='tip po' title='<b>" . lang("delete_salesman_group") . "</b>' data-content=\"<p>" . lang('r_u_sure') . "</p><a class='btn btn-danger po-delete111111' href='" . site_url('system_settings/delete_salesman_group/$1') . "'>" . lang('i_m_sure') . "</a> <button class='btn po-close'>" . lang('no') . "</button>\"  rel='popover'><i class=\"fa fa-trash-o\"></i></a>";
        $this->datatables
            ->select("id as id, name, description")
            ->from("salesman_groups")
            ->add_column("Actions", "<div class=\"text-center\"><a href='" . site_url('system_settings/edit_salesman_group/$1') . "' class='tip' title='" . lang("edit_salesman_group") . "' data-toggle='modal' data-backdrop='static' data-keyboard='false' data-target='#myModal'><i class=\"fa fa-edit\"></i></a> {$delete_salesman_group}</div>", "id");
        echo $this->datatables->generate();
    }
	...
	function getBoms(){
        ...
        $this->datatables->add_column("Actions", "<div class='text-center'><a href='" . site_url('system_settings/edit_bom/$1') . "' class='tip' title='" . lang("edit") . "'><i class='fa fa-edit'></i></a> " . $delete_link . "</div>", "id");
        echo $this->datatables->generate();
    }
