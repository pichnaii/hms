...
class Settings_model extends CI_Model
{
    ...
    public function updateSetting($data,$stockmoves)
    {
    ...
    public function getTaxValidationByID($id)
    {
    ...
    public function updateTaxValidation($id, $data = array())
    {
        $this->db->where('id', $id);
        if ($this->db->update('tax_validations', $data)) {
            return true;
        }
        return false;
    }
    public function addTaxValidation($data)
    {
        if ($this->db->insert('tax_validations', $data)) {
            return true;
        }
        return false;
    }
    public function deleteTaxValidation($id)
    {
        if ($this->db->delete('tax_validations', array('id' => $id))) {
            return true;
        }
        return FALSE;
    }
    public function getAllTaxValidation()
    {
        $q = $this->db->get('tax_validation');
        if ($q->num_rows() > 0) {
            foreach (($q->result()) as $row) {
                $data[] = $row;
            }
    ...
    public function getExpenseCategoryByParentID($id)
    {
    ...
    public function setProductPriceForCustomer($product_id, $customer_id, $price)
    {
    ...
    public function getCustomerPrice($customer_id, $product_id)
    {
    ...
    public function getCustomerProductPriceByPID($product_id, $customer_id)
    {
    ...
    public function deleteCustomerProductPrice($product_id, $customer_id)
    {
    ...
    public function updateFloor($id, $data = array())
    {
    ...
    public function updateDriver($id, $data = array())
    {
    ...
    public function getProjectByBillerID($id)
    {
        if($id){
    ...
    public function getInstallmentTermByID($id)
    {
    ...
    public function addInstallmentTerm($data)
    {
    ...
    public function updateInstallmentTerm($id, $data = array())
    {
    ...
    public function addFrequency($data)
    {
    ...
    public function updateFrequency($id, $data = array())
    {
    ...
    public function updateCategoryProduct($id, $code, $name, $price)
    {
    ...
    public function getAccountByParent($parent_code)
    {
    ...
    public function clearSystem($data)
    {
        if($data){
    ...
    public function updateTank($id, $data = array())
    {
    ...
    public function updateProductWarehouseAlertQty($product_id, $warehouse_id, $alert_qty)
    {
    ...
    public function getProductWarehouseAlert($product_id, $warehouse_id)
    {
    ...
    public function addNozzleStartNo($data,$salesmans)
    {
    ...
    public function updateNozzleStartNo($id, $data, $salesman)
    {
    ...
    {
        $q = $this->db->where("id", $id)->get("cus_tank_nozzles");
        if($q->num_rows() > 0){
            $row = $q->row();
            return $row;
        }
    ...
    public function updateProductPromotion($id, $data = array())
    {
        $this->db->where('id', $id);
    ...
    public function getProductPromationByID($id)
    {
    ...
    public function getSalemanTargetByID($id)
    {
    ...
    public function addSalemanTarget($data)
    {
    ...
    public function updateSalemanTarget($id, $data = array())
    {
        $this->db->where('id', $id);
    ...
    public function deleteSalemanTarget($id)
    {
    ...
    public function deleteInventoryOpeningBalance($id)
    {
    ...
    public function getFuelTimesByID($id)
    {
    ...
    public function updateFuelTime($id, $data = array())
    {
        $this->db->where('id', $id);
    ...
    {
        $q = $this->db->get_where('areas', array('id' => $id), 1);
        if ($q->num_rows() > 0) {
            return $q->row();
        }
        return FALSE;
    ...
    public function addSalesmanGroup($data)
    {
    ...
    public function updateSalesmanGroup($id, $data = array())
    {
        $this->db->where('id', $id);
    ...
    public function deleteSalesmanGroup($id)
    {
    ...
    public function getSalesmanGroupByID($id)
    {
    ...
    {
        if ($this->db->insert("project_group", $data)) {
            return true;
        }
        return false;
    }

    public function deleteProjectGroup($id)
    {
        if ($this->db->delete("project_group", array('id' => $id))) {
            return true;
        }
        return FALSE;
    }
    ...
    {
        $q = $this->db->get_where("project_group", array('id' => $id), 1);
        if ($q->num_rows() > 0) {
            return $q->row();
        }
        return FALSE;
    ...
    public function addLocations($data = false)
    {
        ...
        public function addLocationsImport($data)
    {
        if ($this->db->insert_batch('locations', $data)) {
            return true;
        }
        return false;
    }
    ...
    {
        $this->db->where('country_id', NULL)->or_where('country_id', 0);
    ...
    public function getAllTypesLocations()
    {
        $q = $this->db->get('locations_types');
        if ($q->num_rows() > 0) {
            foreach (($q->result()) as $row) {
    ...
    public function getLocationsTypeByID($id)
    {
        $q = $this->db->get_where('locations_types', array('id' => $id), 1);
        if ($q->num_rows() > 0) {
            return $q->row();
        }
        return FALSE;
    ...
    {
        $q = $this->db->get_where('locations', array('id' => $id),1);
        if ($q->num_rows() > 0) {
            return $q->row();
        }
        return FALSE;
    ...
    {
        if ($this->db->delete("locations", array('id' => $id))) {
            return true;
        }
        return FALSE;
    }

    public function updateProjectGroup($id, $data = array())
    {
        if ($this->db->update("project_group", $data, array('id' => $id))) {
            return true;
        }
        return false;
    }

    public function updateLocations($id, $data = array())
    {
        if ($this->db->update("locations", $data, array('id' => $id))) {
            return true;
        }
        return false;
    }
    ...
    public function deleteBranchPrefixs($id)
    {
        if ($this->db->delete('order_ref', array('id' => $id))) {
            return true;
        }
        return FALSE;
    }
    ...
    public function getProjectByBillers($billers){
